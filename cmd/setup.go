...
DBT_API_SERVICE_URL=http://atrean-dbt-backend:8001/dbt
FRONTEND_URL=http://atrean-ui
PUBLIC_FRONTEND_URL_STAGING=https://YOUR_STAGING_URL
PUBLIC_FRONTEND_URL_PRODUCTION=http://atrean-ui
PUBLIC_FRONTEND_URL_DEVELOPMENT=http://atrean-ui
...
ONEDRIVE_REDIRECT_URL=http://atrean-backend:8000/onedrive/callback
